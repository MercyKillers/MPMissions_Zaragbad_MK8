player createDiarySubject ["404games", "Server Information"];
...
<br/>
	...
	Suspect a player is hacking or exploiting? Please report it at: mercykillers.eu<br/><br/>
...
<br/>
	...
	4 - 5 fixed small outposts around the map.<br/><br/>
